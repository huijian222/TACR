...
def create_data(variant):
    ...
    download_control = variant['downrequire']
    if download_control is True:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--downrequire', type=bool, default=False) #due to aleardy exist such dataset, we do not dnowload
